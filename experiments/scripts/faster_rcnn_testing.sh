...
case $DATASET in
  ...
  rgz09)
    ...
    ;;
  rgz10)
    TRAIN_IMDB="rgz_2017_train10"
    TEST_IMDB="rgz_2017_test10"
    PT_DIR="rgz"
    ITERS=220000
    ;;
  rgz11)
    ...
    ;;
  rgz12)
    TRAIN_IMDB="rgz_2017_train12"
    TEST_IMDB="rgz_2017_test12"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz13)
    TRAIN_IMDB="rgz_2017_train13"
    TEST_IMDB="rgz_2017_test13"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz14)
    TRAIN_IMDB="rgz_2017_train14"
    TEST_IMDB="rgz_2017_test14"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz15)
    TRAIN_IMDB="rgz_2017_train15"
    TEST_IMDB="rgz_2017_test15"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz16)
    TRAIN_IMDB="rgz_2017_train16"
    TEST_IMDB="rgz_2017_test16"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz17)
    TRAIN_IMDB="rgz_2017_train17"
    TEST_IMDB="rgz_2017_test17"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz18)
    TRAIN_IMDB="rgz_2017_train18"
    TEST_IMDB="rgz_2017_test18"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz19)
    TRAIN_IMDB="rgz_2017_train19"
    TEST_IMDB="rgz_2017_test19"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  rgz21)
    ...
    ;;
  rgz22)
    TRAIN_IMDB="rgz_2017_train22"
    TEST_IMDB="rgz_2017_test22"
    PT_DIR="rgz"
    ITERS=80000
    ;;
  pascal_voc)
